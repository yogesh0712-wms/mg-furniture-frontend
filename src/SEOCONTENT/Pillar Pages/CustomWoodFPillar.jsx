...
const customFurnitureData = {
  ...
  contentCards: [
    ...
    {
      title: "Buying Checklist: What to Check Before You Order in Jaipur",
      description:
        "Before you place your order for custom wooden furniture in Jaipur, use this practical checklist — from wood grade to warranty — so you never get surprised after delivery.",
      category: "CheckList",
      image:
