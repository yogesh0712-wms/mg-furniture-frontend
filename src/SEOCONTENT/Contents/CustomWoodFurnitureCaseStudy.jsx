              ...
              <div className="space-y-5 font-sans">
                <div>
                  ...
                  <p className="text-stone-500 text-sm leading-relaxed">
                    ...
                    study-cum-guest room (10×10 ft) had awkward alcoves that
                    made standard furniture placement impossible.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-stone-700 mb-1">
                  ...
                  <p className="text-stone-500 text-sm leading-relaxed">
                    ...
                    obvious headboard wall. Every room had at least one
                    constraint that off-the-shelf furniture couldn't handle.
                  </p>
                </div>
              </div>
                ...
                >
                  ...
                  <ul className="space-y-1.5">
                    {col.points.map((pt) => (
                      <li
                        key={pt}
                        className="flex gap-2 text-stone-500 text-sm"
                      >
            ...
            <div className="space-y-6 font-sans">
              ...
              <div>
                ...
                <p className="text-stone-500 text-sm leading-relaxed">
                  ...
                  with flanking shelves on both sides. The mid-wall bedroom
                  window became a design feature — the headboard was split into
                  two side panels with floating nightstands that left the window
                  clear.
                </p>
              </div>
              <div>
                ...
                <p className="text-stone-500 text-sm leading-relaxed">
                  All pieces were designed with a consistent language:
                  flat-panel doors, 18mm solid Sheesham slabs, concealed hinges,
                  and matte black iron hardware. A warm natural oil finish was
                  chosen over lacquer to preserve the grain and allow easy
                  re-oiling in future years.
                </p>
              </div>
            </div>
            <HighlightBox>
              Every piece of custom wood furniture in Jaipur we build begins
              with a site visit — because a room is never just a set of
              measurements. It has personality, light, and constraints that only
              become visible in person.
            </HighlightBox>
          </FadeSection>
            ...
            <div className="grid md:grid-cols-3 gap-5 font-sans">
              ...
              <div className="bg-white rounded-2xl p-5 border border-amber-100 shadow-sm">
                ...
                <ul className="text-stone-500 text-sm space-y-1.5">
                  ...
                  <li className="flex gap-2">
                    <span className="text-amber-500">▸</span> 6mm toughened
                    glass shelves
                  </li>
                </ul>
              </div>
              <div className="bg-white rounded-2xl p-5 border border-amber-100 shadow-sm">
                ...
                <ul className="text-stone-500 text-sm space-y-1.5">
                  <li className="flex gap-2">
                    <span className="text-amber-500">▸</span> Danish oil (2
                    coats) + wax topcoat
                  </li>
                  <li className="flex gap-2">
