      ...
      <main className="max-w-3xl mx-auto px-5 md:px-6 py-16 space-y-16">
        ...
        <div className="fade-up space-y-4">
          <p className="text-lg" style={{ color: "#4a3728" }}>
            Meera and Rajesh had been living in their Jaipur home for six years.
            The house looked fine from the outside — painted, well-kept, and
            filled with furniture bought over time from various stores. But
            every time they walked in, something felt off. The home never truly
            felt like theirs.
          </p>
          <p style={{ color: "#6b5344" }}>
            This is the story of how they discovered the difference that{" "}
            <strong>custom wood furniture in Jaipur</strong> can make — not just
            to a room, but to the feeling of coming home.
          </p>
        </div>
        ...
        <section className="space-y-10">
          ...
          <div className="fade-up space-y-3">
            <h3 className="text-xl font-semibold" style={{ color: "#3d2410" }}>
              Home looked complete but didn't feel right
            </h3>
            <p style={{ color: "#5c4535" }}>
              Every piece of furniture was purchased with good intentions. A TV
              unit from one brand, a bed frame from another, a wardrobe that
              didn't quite match the wall colour. On paper, everything was
              there. In reality, nothing spoke to each other. The home felt
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              Storage was always a problem. Clothes piled up. Books had no home.
              The kitchen felt cramped despite having enough square footage. It
              was a space management problem that standard furniture could never
              solve.
            </p>
          </div>
        ...
        <section className="space-y-10">
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              The breaking point came when their son's study table — barely two
              years old — collapsed at one side during exams. That was the
              moment Meera sat down and said: "We are done buying furniture that
              doesn't last."
            </p>
          </div>
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              ...
              forced them to adjust their lives around it — instead of the other
              way around.
            </p>
          </div>
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              ...
              wood, no MDF shortcuts, and built to the exact dimensions of your
              space. The price was higher upfront. But Rajesh did the math. In
              ten years, replacing cheap furniture three times over cost far
              more. They decided to invest once, and invest well.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-10">
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              ...
              many people slept in each room? Did the children need study space
              inside the bedroom? What did they wish they had more of — storage,
              seating, surfaces?
            </p>
            <p style={{ color: "#5c4535" }}>
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              Sketches were made, room by room. The awkward corner in the living
              room became a custom L-shaped bookshelf that doubled as a display
              unit. The bedroom wardrobe was designed to reach the ceiling —
              eliminating the dust-collecting space on top that Meera had always
              disliked. Their son got a study table with a hutch, drawers, and a
              corkboard panel built in.
            </p>
          </div>
        ...
        <section className="space-y-10">
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              The bedroom felt 30% larger — not because it grew, but because the
              furniture finally belonged there. The wardrobe tucked against the
              wall perfectly. The study table fit into the alcove as if it was
              always meant to be there. The wasted corner in the living room
              became the most-commented-on feature whenever guests visited.
            </p>
          </div>
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              Small things made large differences. Drawers that opened smoothly.
              A wardrobe shelf at exactly the right height. A bedside unit with
              just enough space for a book, a glass of water, and a phone —
              nothing more cluttered, nothing missing. The home started working
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              Sheesham wood has a natural warmth that no laminate can replicate.
              The grain, the texture, the slight variation from piece to piece —
              it made the home feel alive. Meera chose a matte walnut finish
              that complemented the terracotta walls. Suddenly, the home had a
              point of view. A style. A soul.
            </p>
          </div>
        </section>
        ...
        >
          <p
            ...
            style={{ color: "#3d2010" }}
          >
            "The first evening after everything was set up, we just sat quietly
            in the living room. Nobody said anything. We just looked around and
            smiled."
          </p>
          <footer
            className="mt-3 text-sm"
        ...
        <section className="space-y-10">
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              Two years later, nothing has wobbled. No hinge has come loose. No
              surface has peeled. Meera says she has stopped thinking about
          ...
          <div className="fade-up space-y-3">
            ...
            <p style={{ color: "#5c4535" }}>
              ...
              remember it. And every evening, when the family sits together, the
              space holds them the way a home should.
            </p>
          </div>
        </section>
        ...
        <section className="fade-up space-y-6">
          ...
          <p style={{ color: "#5c4535" }}>
            Meera and Rajesh's story isn't unusual. Many families in Jaipur are
            navigating the same frustrations — homes that look okay but never
            feel fully right. If any part of this resonates, here's what their
            experience teaches:
          </p>
