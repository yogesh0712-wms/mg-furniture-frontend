...
const ChairsFAQs = [
  {
    question: "Do you provide custom wooden shoe racks in Jaipur?",
    answer:
      "Yes, we design and build custom wooden shoe racks based on your space and storage needs across Jaipur.",
  },
  {
    question: "Can I customize the size and design of the shoe rack?",
    answer:
      "Yes, all shoe racks are made on order, so you can customize the design, size, and finish.",
  },
  {
    question: "Do you offer compact shoe rack designs for small spaces?",
    answer:
      "Yes, we create space-saving shoe rack designs that are perfect for small areas.",
  },
  {
    question: "What type of wood is used for shoe racks?",
    answer: "We use high-quality wood to ensure durability and long-term use.",
  },
  {
    question: "How long does it take to complete a shoe rack?",
    answer:
      ...
      <div className="mx-auto w-[95%] md:w-[90%] flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-[40%]">
          <p className="font-serif text-2xl md:text-4xl px-4 md:pl-10 pt-8 md:pt-20">
            Wooden Shoe Racks for Home in Jaipur
          </p>

          <p className="px-4 md:pl-10 pt-6 md:pt-10 text-sm md:text-base">
            Compact and durable wooden shoe racks designed for everyday use in
            your home. Built with quality wood and clean finishing, each unit
            can be customized based on your space, storage needs, and budget in
            Jaipur.
          </p>
          ...
          <div className="mt-8 md:mt-10 px-4 md:ml-10 flex flex-col sm:flex-row gap-4">
            ...
            <a
              href="https://wa.me/919782545485?text=Hi%2C%20I%20am%20looking%20for%20a%20custom%20wooden%20shoe%20rack%20for%20my%20home%20in%20Jaipur.%20Can%20you%20share%20design%20options%20and%20pricing%3F"
              target="_blank"
      ...
      <div className="mt-16 bg-[#f8ffe2]">
        <div className="mx-auto w-[95%] md:w-[50%] pt-10 md:pt-14">
          <p className="text-2xl md:text-3xl text-center font-poppins">
            Custom Wooden Shoe Racks Designed for Smart Storage
          </p>

          <p className="flex flex-col gap-3 mt-5 mb-8 text-sm md:text-base">
            <p>
              Our wooden shoe racks are designed to keep your space organized
              while maintaining a clean and simple look. Whether you need a
              compact rack for a small area or a larger storage unit, we create
              designs that fit perfectly into your home.
            </p>
            <p>
              Each shoe rack is built using high-quality wood, ensuring
              durability and long-term use. From open racks to closed storage
              designs, we offer custom options based on your space and storage
              requirements
            </p>
            <p>
              If you're looking for wooden shoe racks for home in Jaipur, we
              focus on practical design, proper space utilization, and clean
              finishing.
            </p>
          </p>

          <img
            src="/image_collection/shop/shoes rack/rack3.webp"
            alt=""
            className="w-full"
          />
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-3">
              <CheckCircle size={24} />
              <p>Compact and space-saving designs available</p>
            </div>
            <div className="flex gap-3">
              <CheckCircle size={24} />
              <p>Suitable for entryways, bedrooms, and storage areas</p>
            </div>
            <div className="flex gap-3">
              <CheckCircle size={24} />
