...
const Almiras = () => {
  ...
  const slides = [
    {
      url: "/image_collection/shop/Almira/almirahero1.png",
      alt: "Mountain Landscape",
      caption: "Majestic Mountains",
    },
    {
      url: "/image_collection/shop/Almira/almirahero2.png",
      alt: "Beach Paradise",
      caption: "Tropical Paradise",
    },
    {
      url: "/image_collection/shop/Almira/almirahero3.png",
      alt: "City Skyline",
      caption: "City Lights",
    },
    {
      url: "/image_collection/shop/Almira/almirahero4.png",
      alt: "Forest Path",
    ...
    <div>
      ...
      <div className="mt-20 bg-[#f8ffe2]">
        <div className="mx-auto w-[50%] pt-14">
          ...
          <img src="/image_collection/shop/Almira/almiracenter.png" alt="" />
          <div>
      ...
      <div className="mb-20">
        ...
        <div className="flex flex-wrap w-[85%] mx-auto gap-10 ">
          {chairImage.map((item) => (
            <div
              className=" w-56 h-96 transition-all duration-300 ease-out
      transform-gpu
