    ...
    <div>
      ...
      <div className="mt-20 bg-[#f8ffe2]">
        <div className="mx-auto w-[50%] pt-14">
          ...
          <img src="/image_collection/shop/beds/bedscenter.png" alt="" />
          <div>
      ...
      <div className="mb-20">
        <p className="ml-44 mt-10 text-4xl font-bold mb-5">Gallery</p>
        <div className="flex flex-wrap w-[75%] mx-auto gap-10  ">
          {chairImage.map((item) => (
            <div
              className=" w-80 h-72 transition-all duration-300 ease-out
      transform-gpu
