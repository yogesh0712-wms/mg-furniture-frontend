...
const Chairs = () => {
  ...
  return (
    <div>
      ...
      <div className="mx-auto w-full lg:w-[90%] grid grid-cols-1 lg:flex">
        <div className="flex p-2 lg:p-4">
          ...
          >
            ...
            <button
              ...
              className="absolute left-7 lg:left-5 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white border-none w-14 h-14 lg:w-12 lg:h-12 rounded-full cursor-pointer text-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 z-10 shadow-lg"
            ...
            <button
              onClick={() => changeSlide(1)}
              className="absolute right-2 lg:right-5 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white border-none w-12 h-12 rounded-full cursor-pointer text-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 z-10 shadow-lg"
        ...
        <div className=" w-[95%] lg:w-[40%]">
          ...
          <p className="pl-10 lg:text-base text-lg pt-10">
      ...
      <div className="mt-20 bg-[#f8ffe2]">
        <div className="mx-auto w-[70%] lg:w-[50%] pt-14">
          <p className="text-3xl text-center font-poppins">
            Product Description
          </p>
          <p className="mt-5 lg:text-base text-lg mb-8">
          ...
          <img
            src="/image_collection/shop/CHAIRS/chair for pge.jpg"
            alt=""
            className="h-[40vh] lg:h-[80vh] ml-24 lg:ml-44"
          />
          <div>
            <p className="text-2xl lg:text-xl font-poppins mt-5 mb-5">
              Product Features
            </p>
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-xl lg:text-lg">Good quality furniture</p>
                <p className="text-xl lg:text-lg">Quick delivery</p>
                <p className="text-xl lg:text-lg">Various payment methods</p>
              </div>
            </div>
            <p className="mt-5 lg:text-base text-lg">
              Ac ut consequat semper viverra nam libero justo laoreet. In dictum
              non consectetur a erat. Mattis enim ut tellus elementum sagittis.
              Ipsum consequat nisl vel pretium. Neque vitae tempus quam
              pellentesque nec nam. Pharetra magna ac placerat vestibulum. Arcu
      ...
      <div className="mb-20">
        <p className="ml-5 lg:ml-28 mt-10 text-5xl lg:text-4xl font-bold mb-5">
          Gallery
        </p>
        <div className="flex flex-wrap w-[95%] lg:w-[85%] mx-auto gap-5 lg:gap-10 ">
          {chairImage.map((item) => (
            <div
              className=" w-56 h-64 transition-all duration-300 ease-out
      transform-gpu
